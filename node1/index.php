...
<script language="javascript" type="text/javascript">
	function ajaxSetTDS(){
		...
		//    var ratioA = document.getElementById('ratioA').value;
		   ...
		   var minNO = document.getElementById('minNO').value;
		   var queryString = "setRequest.php?timer=" + timer + "&maxPPM25=" + maxPPM25 + "&minPPM25=" + minPPM25 + "&maxPPM10=" + maxPPM10 + "&minPPM10=" + minPPM10 + "&maxSO2=" + maxSO2 + "&minSO2=" + minSO2 + "&maxNO2=" + maxNO2 + "&minNO2=" + minNO2 + "&maxCO=" + maxCO + "&minCO=" + minCO;// ECHO DOC DATA TỪ WEB XUỐNG-> LOAD FILE setrequest.php
		...
		<form>
			<table align='center' border=1 cellspacing=2 cellpadding='4' style="width: 80%;">
				...
				<tr id="trForm">
					...
					<td>
						Danger NO<sub>2</sub> : <input type='number' step='any' name='maxNO2' id='MinNO2'><br>
				...
				<tr id="trForm">
					<td colspan="2"><div>Nhập giá trị để cập nhật</div></td>
					<td>
						<input type="submit" onclick='ajaxSetTDS()' value="submit">
